 ...
 *
 */
extern "C" void sf_Encoder_18_19_Outputs_wrapper(int16_T *pos,
			const real_T *xD,
 ...
 *
 */
extern "C" void sf_Encoder_18_19_Update_wrapper(int16_T *pos,
			real_T *xD,
			const uint8_T *enc, const int_T p_width0,
			const uint8_T *pinA, const int_T p_width1,
			const uint8_T *pinB, const int_T p_width2);

void sf_Encoder_18_19_Update_wrapper(int16_T *pos,
			real_T *xD,
			const uint8_T *enc, const int_T p_width0,
			const uint8_T *pinA, const int_T p_width1,
			const uint8_T *pinB, const int_T p_width2)
