/*
 * File: sf_MPU6050_Driver_GxAyz.cpp
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Nov 06 20:36:10 2025
 */
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port x_vel of S-Function sf_MPU6050_Driver_GxAyz");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y_acc of S-Function sf_MPU6050_Driver_GxAyz");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port z_acc of S-Function sf_MPU6050_Driver_GxAyz");
      return;
    }
