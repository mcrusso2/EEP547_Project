 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Nov 13 20:41:03 2025
 */
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port pos of S-Function sf_Encoder_18_19");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  sf_Encoder_18_19_Outputs_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB,
    p_width2);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const uint8_T *pinA = (const uint8_T *) mxGetUint8s(PARAM_DEF1(S));
  const uint8_T *pinB = (const uint8_T *) mxGetUint8s(PARAM_DEF2(S));
  sf_Encoder_18_19_Update_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB,
    p_width2);
}
