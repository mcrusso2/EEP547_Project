/*
 * File: sf_QuadEncoder_18_19_15_62.cpp
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Oct 23 20:58:76 2025
 */
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port pos1 of S-Function sf_QuadEncoder_18_19_15_62");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port pos2 of S-Function sf_QuadEncoder_18_19_15_62");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  sf_QuadEncoder_18_19_15_62_Outputs_wrapper(pos1, pos2, xD, enc, p_width0, pinA,
    p_width1, pinB, p_width2);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const uint8_T *pinA = (const uint8_T *) mxGetUint8s(PARAM_DEF1(S));
  const uint8_T *pinB = (const uint8_T *) mxGetUint8s(PARAM_DEF2(S));
  sf_QuadEncoder_18_19_15_62_Update_wrapper(pos1, pos2, xD, enc, p_width0, pinA,
    p_width1, pinB, p_width2);
}
