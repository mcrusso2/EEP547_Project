/*
 * File: sf_QuadEncoder_SainSmart.c
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Oct 13 14:32:49 2018
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_QuadEncoder_SainSmart
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_QuadEncoder_SainSmart_Outputs_wrapper(int16_T *pos1,
			int16_T *pos2,
			const real_T *xD,
			const uint8_T  *enc, const int_T  p_width0,
			const uint8_T  *pinA, const int_T  p_width1,
			const uint8_T  *pinB, const int_T  p_width2);
extern void sf_QuadEncoder_SainSmart_Update_wrapper(int16_T *pos1,
			int16_T *pos2,
			real_T *xD,
			const uint8_T  *enc,  const int_T  p_width0,
			const uint8_T  *pinA,  const int_T  p_width1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_QuadEncoder_SainSmart_Outputs_wrapper(pos1, pos2, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_QuadEncoder_SainSmart_Update_wrapper(pos1, pos2,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
